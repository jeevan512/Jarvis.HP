...
try:
    ...
    def sys2():
        def login():
            step = Tk()
            step.title("Login")
            step.geometry("300x200")
            step.config(background="#000000")
            step.attributes("-alpha", 0.5)
            step.iconphoto(False, icon)
            ...
            def Ok():
                ...
                if (lope == "" and password == ""):
                    ...
                    Button(step, text="HP open", command=infoolop, height=3, width=13, bg="black", fg="#00ff0d", bd=10,
            ...
            Label(step, text="username", bg="black", fg="#00ff0d").place(x=10, y=10)
            Label(step, text="password", bg="black", fg="#00ff0d").place(x=10, y=40)
            Label(step, bg="black", fg="#00ff0d", height=80).place(x=50, y=180)
            Label(step, text="SIGN", bg="black", fg="#00ff0d", font=("Arial", 100)).place(x=400, y=0)
            Label(step, text="IN", bg="black", fg="#00ff0d", font=("Arial", 100)).place(y=130, x=500)
            ...
            Button(step, text="Login", command=Ok, height=3, width=13, bg="black", fg="#00ff0d", bd=10,
                   relief=RAISED).place(
                x=10,
                y=100)
            ...
            Radiobutton(step, text="show", bg="black", fg="#00ff0d", command=SH, value=0).place(x=0, y=72)

            def SHO():
                e2.config(show="*")

            Radiobutton(step, text="hide", bg="black", fg="#00ff0d", command=SHO, value=1).place(x=60, y=72)

            menu = Menu(step)
            step.config(menu=menu)
            filemenu = Menu(menu)
            ...
            def infoolop():
                ...
                Button(hack, text="youtube", bg="black", fg="#00ff0d", command=youtube, height=3, width=13,
                       bd=10).place(x=0,
                                    y=0)
                Button(hack, text="family", bg="black", fg="#00ff0d", command=family, height=3, width=13, bd=10).place(
                    x=0,
                    y=70)
                Button(hack, text="chrome", bg="black", fg="#00ff0d", command=bew, height=3, width=13, bd=10).place(x=0,
                                                                                                                    y=150)
                Button(hack, text="whats app", bg="black", fg="#00ff0d", command=whatsapp, height=3, width=13,
                       bd=10).place(x=0,
                                    y=220)
                Button(hack, text="snake game", bg="black", fg="yellow", command=snake, height=3, width=13,
                       bd=10).place(x=0,
                                    y=290)
                Button(hack, text="counting un", bg="black", fg="#00ff0d", command=counting, height=3, width=13,
                       bd=10).place(
                    x=0,
                    y=360)
                Button(hack, text="quiz game", bg="black", fg="#00ff0d", command=qgame, height=3, width=13,
                       bd=10).place(x=0,
                                    y=430)
                Button(hack, text="password", bg="black", fg="yellow", command=hellopassword, height=3, width=13,
                       bd=10).place(
                    x=0,
                    y=500)
                Button(hack, text="scratch code", bg="black", fg="#00ff0d", command=scratch, height=3, width=13,
                       bd=10).place(
                    x=0,
                    y=580)
                Button(hack, text="Google slides", bg="black", fg="#00ff0d", command=slides, height=3, width=13,
                       bd=10).place(
                    x=130,
                    y=0)
                Button(hack, text="Panzoid", bg="black", fg="#00ff0d", command=pan, height=3, width=13, bd=10).place(
                    x=130,
                    y=100)
                Button(hack, text="car game", bg="black", fg="#00ff0d", command=care, height=3, width=13, bd=10).place(
                    x=130,
                    y=200)
                Button(hack, text="BMI", bg="black", fg="#00ff0d", command=mio, height=3, width=13, bd=10).place(x=130,
                                                                                                                 y=300)
                Button(hack, text="quiz game", bg="black", fg="#00ff0d", command=lipl, height=3, width=13, bd=10).place(
                    x=130,
                    y=400)
                Button(hack, text="music", bg="black", fg="#00ff0d", command=music, height=3, width=13, bd=10).place(
                    x=130,
                    y=480)
            ...
            def care():
                ...
                def button(msg, x, y, w, h, ic, ac, action=None):
                    ...
                    if x + w > mouse[0] > x and y + h > mouse[1] > y:
                        ...
                        if click[0] == 1 and action != None:
                            if action == "play":
                                countdown()
                            elif action == "quit":  # js.inter.fast
                                pygame.quit()
                                quit()
                                sys.exit()
                            elif action == "intro":
                    ...
                    smalltext = pygame.font.Font("freestanding.ttf", 20)
                ...
                def introduction():
                    ...
                    while introduction:
                        ...
                        textSurf, textRect = text_objects("This is an car game in which you need dodge the coming cars",
                                                          smalltext)
            ...
            def lipl():
                ...
                Button(root, text="enter", command=q1, bg="black", fg="#00ff0d", height=3, width=13, bd=10,
                       relief=RAISED).place(
                    x=70, y=20)
            ...
            def htg():
                ...
                pygame.mixer.music.load("Believer_192(PagalWorld).mp3")
            ...
            def music():
                ...
                Button(mus, text="play", bg="black", fg="#00ff0d", command=htg, font=("Helvetica", 32), bd=10).pack(
                    pady=20)
    ...
    def clear_buttons():  # Function to clear buttons
        buttons_to_forget = (l1, l2, l3, l4)  # Corrected
        for widget in buttons_to_forget:
            widget.place_forget()
        lable=Label(root1, text="Created by Rithvik", fg="blue", bg="black", relief=RAISED).place(x=250, y=80)
        babble=Button(root1, text="<---Back", bg="#09f6ff", height=3, width=15, relief=RAISED, bd=0, command=gte).place(x=250, y=120)

    def gte():
        buttons_to_place = (l1, l2, l3, l4, l5)  # l5 added
        for widget in buttons_to_place:
            try:
                widget.place()  # place buttons first
            except AttributeError:
                widget.pack()  # place l5
